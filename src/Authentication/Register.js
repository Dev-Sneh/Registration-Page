    ...
    return (
        <div className='registration'>
            ...
            <form onSubmit={handleChange}>
                <label>Email:
                    <input onChange={(e) => setEmail(e.target.value)} type="text" value={email} autoComplete="off" />
                </label>
                <br></br>
                <label>Password:
                ...
                <label>Phone number:
                    <input onChange={(e) => setNumber(e.target.value)} type="tel" value={number} placeholder='Enter your number' />
                </label>
                <p></p>
